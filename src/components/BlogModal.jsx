      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-invert prose-accent max-w-none">
            <p className="text-white/80 text-xl font-light leading-relaxed first-letter:text-5xl first-letter:font-bold first-letter:text-accent first-letter:mr-3 first-letter:float-left">
              {blog.excerpt}
            </p>
